...
- Ordinary model load, transcription, and local translation stay offline; only explicit downloads, AI requests, or enabled API translation use the network.
